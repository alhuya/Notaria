    ...
    <div class="@if($tipo=='fisico') fisico @endif">
        ...
        <table width="100%" class="tabla3">
            <tr>
                ...
                <td align="center" class="fondo"><strong>Apellido Paterno</strong></td>
                <td align="center" class="fondo"><strong>Apellido Materno</strong></td>
                <td align="center" class="fondo"><strong>Correo</strong></td>
                <td align="center" class="fondo"><strong>Puesto</strong></td>
                <td align="center" class="fondo"><strong>Estado</strong></td>
               
            </tr>
          @foreach($Usuarios as $usuario)
            <tr> 
                <td width="20%" align="center"  ><span class="text">{{ $usuario->nombre }}</span></td>
                <td ><span class="text">{{ $usuario->ap_paterno }}</span></td>
                <td><span class="text">{{ $usuario->ap_materno }}</span></td>
                <td><span class="text">{{ $usuario->email }}</span></td>
                <td><span class="text">{{ $usuario->puesto }}</span></td>
                <td><span class="text">{{ $usuario->estado }}</span></td>
            </tr>
            @endforeach
