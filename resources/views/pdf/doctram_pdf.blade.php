...
<html>
<head>
    <title>Reporte Documentación por Trámite</title>
    <style type="text/css">
    body{
        font-size: 16px;
        font-family: "Arial";
...
<body>
        ...
        <h2 style="text-align: center;" >Reporte Documentación por Trámite</h2>
        <table width="100%" class="tabla2"> 
        <tr>
            
                <td width="11%">Usuario:</td>
               @foreach($Clientes as $cliente)
                <td width="37%" class="linea"><span class="text">{{$cliente->nombre }} {{$cliente->apellido_paterno }} {{$cliente->apellido_materno }} </span></td>
              @endforeach
                <td width="5%">&nbsp;</td>
                <td width="13%">&nbsp;</td>
                <td width="4%">&nbsp;</td>
            ...
            <tr>
                ...
                <td class="linea" >{{ $documento->tramite }}</td>
                @break;
                @endforeach
                <td></td>
                <td></td>
        ...
        <table width="70%" class="tabla3">
            <tr>
           
                <td align="center" class="fondo"><strong>Documentos</strong></td>
                                   
            </tr>
          @foreach($Documentos as $documento)
            <tr> 
                
                <td ><span class="text">{{ $documento->documento }}</span></td>
