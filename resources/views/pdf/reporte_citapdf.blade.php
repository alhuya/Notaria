...
<body>
        ...
        <tr>
               ...
               @foreach($usuarios as $usuario)
                <td width="37%" class="linea"><span class="text">{{$usuario->nombre }} {{$usuario->ap_paterno }} {{$usuario->ap_materno }} </span></td>
              @endforeach
                <td width="5%">&nbsp;</td>
                <td width="13%">&nbsp;</td>
                <td width="4%">&nbsp;</td>
        ...
        <table width="100%" class="tabla3">
            <tr>
                ...
                <td align="center" class="fondo"><strong>Fecha Hora</strong></td>
                <td align="center" class="fondo"><strong>Tipo Trámite</strong></td>
                <td align="center" class="fondo"><strong>Tipo Cita</strong></td>
                                   
            </tr>
          @foreach($valores as $valor)
            <tr> 
                <td width="20%" align="center"><span class="text"> {{ $valor->nombre }} {{ $valor->apellido_paterno }} {{ $valor->apellido_materno }} </span></td>
                <td ><span class="text">{{ $valor->fecha_hora }}</span></td>
                <td ><span class="text">{{ $valor->tramite }}</span></td>
                <td ><span class="text">{{ $valor->tipo }}</span></td>
