...
<body>
        ...
        <tr>
              ...
              <td width="11%">Cliente:</td>
               @foreach($Escrituras as $escritura)
                <td width="37%" class="linea"><span class="text">{{$escritura->nombre }} {{$escritura->apellido_paterno}} {{$escritura->apellido_materno }}</span></td>
              @endforeach
              @endif
              @if($dato == 'Carpeta')
              <td width="20%">Número de Carpeta:</td>
               @foreach($Escrituras as $escritura)
        ...
        <table width="100%" class="tabla3">
            <tr>
                ...
                <td align="center" class="fondo"><strong>Trámite</strong></td>
          ...
          @foreach($Escrituras as $escritura)
            <tr> 
                ...
                <td ><span class="text">{{$escritura->nombre }} {{$escritura->apellido_paterno}} {{$escritura->apellido_materno }}</span></td>
                ...
                <td ><span class="text">{{ $escritura->kinegrama }}</span></td>
