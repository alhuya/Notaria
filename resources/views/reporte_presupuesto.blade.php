          ...
          //  console.log(numero);
           ...
           // console.log(response); 
                ...
                for(i=0; i<response.length; i++){
                   ...
                   $("#concepto").append('"<tr><th><td>'+response[i].concepto+'</td><td>'+response[i].costo+'</td><td>'+resta + '</td></th><tr>"'); 

                      cantidad =  total - total2;

                }
                $("#total").append('"<tr><th><td>total</td><td>'+total+ '</td><td>'+cantidad+ '</td></th></tr>"'); 
                $("#div2").append("<a target='_blank' href='pdf/pdf_presupuesto/"+numero+"/"+cantidad+"/"+total+"'>Ver PDF digital</a>"); 
