...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-07-2018 a las 21:06:25
...
CREATE TABLE `categorias_funciones` (
  `categoria_funcion_id` int(10) UNSIGNED NOT NULL,
...
INSERT INTO `categorias_funciones` (`categoria_funcion_id`, `nombre`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE `categorias_puestos` (
  `categria_puesto_id` int(10) UNSIGNED NOT NULL,
...
INSERT INTO `clientes` (`cliente_id`, `nombre`, `apellido_paterno`, `apellido_materno`, `telefono`, `celular`, `correo`, `calle`, `colonia`, `numero_interior`, `numero_exterior`, `codigo_postal`, `estado_id`, `municipio_id`, `created_at`, `updated_at`) VALUES
(1, 'ghj', 'hj', 'hj', '78', '78', 'ghj@dsdsd.com', 'ghj', 'ghj', '678', '78', '789', '14', 'ghjk', '2018-07-03 06:54:09', '2018-07-03 06:54:09');
...
CREATE TABLE `documentacion` (
  `documentacion_id` int(10) UNSIGNED NOT NULL,
...
INSERT INTO `documentacion` (`documentacion_id`, `documento`, `costo`, `origen`, `created_at`, `updated_at`) VALUES
(1, 'Acta de Nacimiento', '0', 'Cliente', '2018-07-03 18:39:54', '2018-07-03 18:39:54');
...
(1, 'Caja', 'no', '2018-06-25 21:38:37', '2018-06-25 21:38:37'),
(2, 'control', 'no', '2018-07-03 16:25:45', '2018-07-03 16:25:45'),
(3, 'Administrador', 'no', '2018-07-04 06:00:00', '2018-07-04 06:00:00');
...
CREATE TABLE `tipos_tramites` (
  `tipos_tramite_id` int(10) UNSIGNED NOT NULL,
...
INSERT INTO `tipos_tramites` (`tipos_tramite_id`, `tramite`, `duracion`, `created_at`, `updated_at`) VALUES
(1, 'Testamento', '15', '2018-07-03 17:33:01', '2018-07-03 17:33:01'),
(2, 'Compra Venta', '20', '2018-07-03 17:34:03', '2018-07-03 17:34:03');
...
CREATE TABLE `tipo_citas` (
  `tipo_cita_id` int(10) UNSIGNED NOT NULL,
...
(12, 'Laura', 'Cardenas', 'Herrera', 'laura89@hotmail.com', 3, '$2y$10$BCCnIL/4j8xVVA0fEsap5.WL0mWARfB41hVHOLFftvlE4CR.g9c2C', 'Cumsb66B5wfqfSbJRIiWQQdQk1Vv0zCPOHdnYEKTaxe5ksWCjBKW6GG9BK3x', '2018-07-05 18:04:14', '2018-07-05 18:04:14'),
(13, 'vanessa', 'reyez', 'Rivas', 'vanesa@hotmail.com', 1, '$2y$10$Iw.z6k2zKkKppZkA4LdvtONTaWkS170Lb//rhpoIStGQUUt0ZtdSu', NULL, '2018-07-05 19:41:06', '2018-07-05 19:41:06'),
(14, 'vanessa', 'reyez', 'Rivas', 'vanesa4@hotmail.com', 1, '$2y$10$U7EuWLTiLCD1aFtPSK2u4u9iz5YvIXZnij5hrnw5hHQtQOQ9sNZTi', NULL, '2018-07-05 19:42:56', '2018-07-05 19:42:56');
...
ALTER TABLE `categorias_funciones`
  ADD PRIMARY KEY (`categoria_funcion_id`);

--
-- Indices de la tabla `categorias_puestos`
--
ALTER TABLE `categorias_puestos`
  ADD PRIMARY KEY (`categria_puesto_id`);
...
ALTER TABLE `tipos_tramites`
  ADD PRIMARY KEY (`tipos_tramite_id`);
...
--
ALTER TABLE `categorias_funciones`
  MODIFY `categoria_funcion_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `categorias_puestos`
--
ALTER TABLE `categorias_puestos`
  MODIFY `categria_puesto_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `documentacion`
  MODIFY `documentacion_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tipos_tramites`
  MODIFY `tipos_tramite_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `tipo_citas`
--
ALTER TABLE `tipo_citas`
  MODIFY `tipo_cita_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tramites_documento`
  MODIFY `tramite_documento_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
