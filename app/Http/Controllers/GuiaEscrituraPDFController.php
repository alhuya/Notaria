...
use Mpdf\Mpdf;
use DB;
 //pdf de la guia dependiendo del numero de escritura
class GuiaEscrituraPDFController extends Controller
{
    /**
    ...
    public function pdf($accion='ver',$tipo='digital',$id)
    {
      ...
      $Escrituras =  DB::table('control_tramites')
        ...
        if($accion=='html'){
            return view('pdf.pdf_guiaesc',$data,compact('Escrituras'));
        }else{
            $html = view('pdf.pdf_guiaesc',$data,compact('Escrituras'))->render();
        }
